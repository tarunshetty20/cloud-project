        ...
        if ($result->rowCount() > 0) {
            ...
            <form class="form-horizontal" method="post" action="../authenticate/register.php" id="registrationForm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control disabled" name="inputAccount3" id="inputAccount3"
                ...
                <div class="form-group">
                    <label for="inputCompany3" class="col-sm-4 control-label">Company Name <sup
                                class="text-danger">*</sup></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="inputCompany3" id="inputCompany3"
                ...
                <div class="form-group">
                    <label for="inputContactName3" class="col-sm-4 control-label">Contact Name <sup
                                class="text-danger">*</sup></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="inputContactName3" id="inputContactName3"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="tel" pattern="(?:\(\d{3}\)|\d{3})[- ]?\d{3}[- ]?\d{4}"
                               title="10 digit phone number" class="form-control" name="inputContactNumber3"
                               id="inputContactNumber3"
                ...
                <div class="form-group">
                    <label for="inputUsername3" class="col-sm-4 control-label">Username <sup
                                class="text-danger">*</sup></label>
                    <div class="col-sm-8">
                        <input type="email" class="form-control disabled" name="inputUsername3" id="inputUsername3"
                ...
                <div class="form-group">
                    <label for="inputConfirmPassword3" class="col-sm-4 control-label">Confirm Password <sup
                                class="text-danger">*</sup></label>
                    <div class="col-sm-8">
                        <input type="password" class="form-control" name="inputConfirmPassword3"
                               id="inputConfirmPassword3" title="Confirm Password"
